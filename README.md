...
In Part 2, we will learn how to use the array [filter][filter] function in order to change which players are shown. Make sure you've completed all the steps in Part 1 before working on Part 2!
